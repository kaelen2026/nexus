...
| Auth runtime composition factory | done | PR #9 |
...
| LLM generate HTTP endpoint | done | PR #28 |
| Durable LLM request records | in progress | Current feature PR |
| Runtime composition and fake provider wiring | next | Not started |
